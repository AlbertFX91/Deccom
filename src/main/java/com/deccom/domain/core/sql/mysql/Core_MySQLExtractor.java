...
public class Core_MySQLExtractor extends Core_SQLExtractor implements Core_DataExtractor{
	
	private Core_MySQLConnection dataConnection;
	private Core_MySQLStyle style = new Core_MySQLStyle();
	
	public Core_MySQLExtractor() {
	}
