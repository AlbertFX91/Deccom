...
public class Core_ControlVarRunnable implements Runnable{
    ...
    private static final Logger log = LoggerFactory.getLogger(Core_ControlVarRunnable.class);
    
    private Core_ControlVar cv;
    private Core_ControlVarService service;
    
	public Core_ControlVarRunnable(Core_ControlVar cv, Core_ControlVarService service) {
		this.cv = cv;
