...
@Component({
    selector: 'jhi-jsonvisualizer-json',
    templateUrl: './jsonvisualizer-json.component.html',
    styleUrls: [
        'jsonvisualizer-json.css'
    ]
}) export class JSONVisualizerJSONComponent implements OnInit, OnDestroy {
